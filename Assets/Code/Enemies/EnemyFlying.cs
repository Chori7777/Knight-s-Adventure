...
/// <summary>
/// Sistema de movimiento aéreo - Patrulla volando entre puntos
/// </summary>
public class EnemyFlying : MonoBehaviour
{
    ...
    [SerializeField] private float restDuration = 3f; // NUEVO: Tiempo de descanso antes de volver a patrullar
    ...
    private bool isResting = false; // NUEVO: Flag de descanso
    private float restTimer = 0f; // NUEVO: Timer de descanso
    ...
    private void Update()
    {
        ...
        if (playerDetected)
        {
            ...
            isResting = false; // NUEVO: Cancelar descanso si ve al jugador
            restTimer = 0f;
    ...
    private void ReturnToRest()
    {
        ...
        {
            isReturningToRest = false;
            isResting = true; // NUEVO: Empezar a descansar
            restTimer = 0f;
            ...
            Debug.Log($"💤 {gameObject.name} llegó al punto de reposo y descansa por {restDuration}s");
        }
    }
    ...
    private void Rest()
    {
        ...
        if (restTimer >= restDuration)
        {
            ...
            Debug.Log($"⚡ {gameObject.name} terminó de descansar, vuelve a patrullar");
        }
    }
