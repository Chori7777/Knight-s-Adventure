...
public class PlayerHealthUI : MonoBehaviour
{
    ...
    private void UpdateSwordMiddleParts()
    {
        ...
        for (int i = 0; i < swordMiddleParts.Length; i++)
        {
            if (swordMiddleParts[i] != null)
            {
                ...
                swordMiddleParts[i].sprite = (player.Health > healthThreshold) ? middleFullSprite : middleEmptySprite;
            }
        }
    }
    ...
    {
        if (knightHeadImage == null || swordMiddleParts == null || player == null) return;
